...
async def seed():
    ...
    async with AsyncSessionLocal() as db:
        ...
        m3_segs = [
            ...
            (uid(), t3_id, "Alex Chen", "alex@meetmind.ai", 1282.0, 1380.0, "Great question. The three metrics we track are: action item completion rate — we've seen customers go from 35% to 78% completion in the first month. Meeting time saved — average is 40 minutes per meeting when teams use the automated summaries. And search usage — how often people find past decisions without calling another meeting. I'll set up a dashboard for you to track these in real time.", 14),
            (uid(), t3_id, "Sarah Mitchell", "sarah@acmecorp.com", 1382.0, 1460.0, "Those metrics are exactly what our leadership team cares about. Let's commit to the 30-day sprint. Can we start with a training session for the 15 leaders? Maybe a 45-minute webinar?", 15),
            (uid(), t3_id, "Alex Chen", "alex@meetmind.ai", 1462.0, 1540.0, "Absolutely. I'll send calendar invites for next Thursday — does that work for your team? I'll also prepare a custom onboarding guide with Acme Corp branding. Let me confirm our timeline: credentials out by Monday, training webinar Thursday, and you're live by Friday.", 16),
            (uid(), t3_id, "Tom Nguyen", "tom@acmecorp.com", 1542.0, 1600.0, "Thursday works. I'll make sure all 15 leaders block their calendars. This has been a really helpful call, Alex. We're excited to get started.", 17),
        ]
